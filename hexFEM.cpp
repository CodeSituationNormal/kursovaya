...
int el_n = 0, nodes_n = 0, face_n = 0, maxiter = 100000;

double eps = 1e-14, alpha, beta_beta, norma_pr;

double* b_loc = nullptr;

double** D = nullptr;
double** alphaM = nullptr;
double** A_loc = nullptr;
double** M_loc = nullptr;

vector<int> face, ig, jg;
vector<double> val, gg, di , b, q, r, z, Az, Ar, Mr, M;
